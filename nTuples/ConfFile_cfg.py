...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        'file:/afs/cern.ch/work/k/koschwei/public/test/CMSSW_9_2_12_patch1/src/HLTBTagging/nTuples/cmsswPreProcessing.root'
    )
)
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('/afs/cern.ch/work/k/koschwei/public/test/CMSSW_9_2_12_patch1/src/HLTBTagging/nTuples/ntuple.root')
                                   )
