...
process.datasets = cms.PSet(
    ...
    Charmonium = cms.vstring('HLT_Dimuon0_Jpsi3p5_Muon2_v4', 
        ...
        'HLT_DoubleMu2_Jpsi_DoubleTkMu0_Phi_v1', 
        'HLT_DoubleMu2_Jpsi_DoubleTrk1_Phi_v2', 
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    toGet = cms.VPSet(cms.PSet(
        ...
        snapshotTime = cms.string('2017-07-24 12:50:00.000'),
        tag = cms.string('L1Menu_Collisions2017_v3_m6_xml')
    ), 
        cms.PSet(
            connect = cms.string('frontier://FrontierProd/CMS_CONDITIONS'),
            record = cms.string('L1TUtmTriggerMenuRcd'),
