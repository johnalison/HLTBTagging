...
Data = [#["HLT_Ntuple_BTagging_DiLepton_v4",
...
MC = [["HLT_Ntuple_BTagging_DiLepton_v4",
...
#       config.General.requestName = name+"_"+dataset.replace('/',"_")
        config.General.requestName = name + prefix + "_" + dataset[1][0].split('/')[1] + "_" + dataset[1][0].split('/')[2].split("-")[0]
