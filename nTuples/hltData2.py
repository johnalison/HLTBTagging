# hltGetConfiguration /users/koschwei/CMSSW_9_2_10/HLT_TnP_BTag --setup /dev/CMSSW_9_2_0/HLT --data --globaltag auto:run2_hlt_GRun --input root://cms-xrd-global.cern.ch//store/data/Run2017C/MuonEG/RAW/v1/000/299/368/00000/00E9C4F1-E76B-E711-8952-02163E01A27B.root --process MYHLT --full --offline --unprescale --max-events 10 --output none

# /users/koschwei/CMSSW_9_2_10/HLT_TnP_BTag/V3 (CMSSW_9_2_10)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "MYHLT" )
process.load("setup_dev_CMSSW_9_2_0_HLT_cff")

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/koschwei/CMSSW_9_2_10/HLT_TnP_BTag/V3')
)
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.NoFilter_CaloBTagCSV_v1, process.NoFilter_CaloBTagDeepCSV_v1, process.NoFilter_PFBTagCSV_v1, process.NoFilter_PFBTagDeepCSV_v1, process.HLTriggerFinalPath ))
