...
def shapeComparison(loglev, run, doMC, doData, doCSV, doDeepCSV, doperJetComp,sameTaggerComp, crossTaggerComp, onlymatch, doSampleComp, skiponOffPlots, splitDeepCSV, looseSel):
    ...
    if run == "Test":
        ...
        basepath = "v7nTuples_v2/shapeComp/"
        puweight = "wPURunF"
        globalPrefix = "DeepCSVMPresel_phase1_RunA_"
        subfolder = "RunA"
    ...
    if looseSel:
        ...
        offlineSelection = "{0} && abs(offCleanJets_eta) < 2.4 && offCleanJets_pt > 30".format(offlineeventSelection)
        ...
        DataSelection = "1"
        VarSelection = "1"
        TriggerSelection = "HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v6 > 0 || HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v6 > 0"
    ...
    if doCSV and not skiponOffPlots and not onlymatch:
        ...
        OffCSV = modules.classes.PlotBase("offCleanJets_csv", "{0} && {1} && offCleanJets_csv > 0".format(plotVarSelection, offlineSelection), "1", binning1, "CSV value", ROOT.kBlue, "Offline jets")
        CaloCSV = modules.classes.PlotBase("caloJets_csv", "{0} && {1} && caloJets_csv > 0".format(plotVarSelection, caloSelection), "1", binning1, "CSV value", ROOT.kRed, "Calo jets")
        PFCSV = modules.classes.PlotBase("pfJets_csv","{0} && {1} && pfJets_csv > 0".format(plotVarSelection, pfSelection), "1", binning1, "CSV value", ROOT.kGreen+2, "PF jets")
    ...
    if doData and doMC and doCSV and doSampleComp and not onlymatch:
        ...
        OffCSVMC = modules.classes.PlotBase("offCleanJets_csv", "{0} && {1} && offCleanJets_csv > 0".format(plotVarSelection, offlineSelection), "1", binning1, "Offline jet CSV value", ROOT.kRed, "t#bar{t} sample")
        OffCSVData = modules.classes.PlotBase("offCleanJets_csv", "{0} && {1} && offCleanJets_csv > 0".format(plotVarSelection, offlineSelection), "1", binning1, "Offline jet CSV value", ROOT.kBlue, "MuonEG sample")
        ...
        pfCSVMC = modules.classes.PlotBase("pfJets_csv", "{0} && {1} && pfJets_csv > 0".format(plotVarSelection, pfSelection), "1", binning1, "pf jet CSV value", ROOT.kRed, "t#bar{t} sample")
        pfCSVData = modules.classes.PlotBase("pfJets_csv", "{0} && {1} && pfJets_csv > 0".format(plotVarSelection, pfSelection), "1", binning1, "pf jet CSV value", ROOT.kBlue, "MuonEG sample")
        ...
        CaloCSVMC = modules.classes.PlotBase("caloJets_csv", "{0} && {1} && caloJets_csv > 0".format(plotVarSelection, caloSelection), "1", binning1, "calo jet CSV value", ROOT.kRed, "t#bar{t} sample")
        CaloCSVData = modules.classes.PlotBase("caloJets_csv", "{0} && {1} && caloJets_csv >  0".format(plotVarSelection, caloSelection), "1", binning1, "calo jet CSV value", ROOT.kBlue, "MuonEG sample")
    ...
    if doDeepCSV and not skiponOffPlots and not onlymatch:
        ...
        OffDeepCSV = modules.classes.PlotBase("offCleanJets_deepcsv_b", "{0} && {1} && offCleanJets_deepcsv >= 0".format(plotVarSelection, offlineSelection), "1", binning1, "DeepCSV value", ROOT.kBlue, "Offline jets")
        CaloDeepCSV = modules.classes.PlotBase("caloJets_deepcsv", "{0} && {1} && caloJets_deepcsv >= 0".format(plotVarSelection, caloSelection), "1", binning1, "DeepCSV value", ROOT.kRed, "Calo jets")
        PFDeepCSV = modules.classes.PlotBase("pfJets_deepcsv", "{0} && {1} && pfJets_deepcsv >= 0".format(plotVarSelection, pfSelection), "1", binning1, "DeepCSV value", ROOT.kGreen+2, "PF jets")
    ...
    if doData and doMC and doDeepCSV and doSampleComp and not onlymatch:
        ...
        OffDeepCSVMC = modules.classes.PlotBase("offCleanJets_deepcsv_b", "{0} && {1} && offCleanJets_deepcsv >= 0".format(plotVarSelection, offlineSelection), "1", binning1, "Offline jet DeepCSV value", ROOT.kRed, "t#bar{t} sample")
        OffDeepCSVData = modules.classes.PlotBase("offCleanJets_deepcsv_b", "{0} && {1} && offCleanJets_deepcsv >= 0".format(plotVarSelection, offlineSelection), "1", binning1, "Offline jet DeepCSV value", ROOT.kBlue, "MuonEG sample")
        ...
        pfDeepCSVMC = modules.classes.PlotBase("pfJets_deepcsv", "{0} && {1} && pfJets_deepcsv >= 0".format(plotVarSelection, pfSelection), "1", binning1, "pf jet DeepCSV value", ROOT.kRed, "t#bar{t} sample")
        pfDeepCSVData = modules.classes.PlotBase("pfJets_deepcsv", "{0} && {1} && pfJets_deepcsv >= 0".format(plotVarSelection, pfSelection), "1", binning1, "pf jet DeepCSV value", ROOT.kBlue, "MuonEG sample")
        ...
        CaloDeepCSVMC = modules.classes.PlotBase("caloJets_deepcsv", "{0} && {1} && caloJets_deepcsv >= 0".format(plotVarSelection, caloSelection), "1", binning1, "calo jet DeepCSV value", ROOT.kRed, "t#bar{t} sample")
        CaloDeepCSVData = modules.classes.PlotBase("caloJets_deepcsv", "{0} && {1} && caloJets_deepcsv >= 0".format(plotVarSelection, caloSelection), "1", binning1, "calo jet DeepCSV value", ROOT.kBlue, "MuonEG sample")
    ...
    if doCSV and not skiponOffPlots and onlymatch:
        ...
        OffCSV = modules.classes.PlotBase("offCleanCSVJets_csv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, "CSV value", ROOT.kBlue, "Offline jets")
        CaloCSV = modules.classes.PlotBase("caloJets_csv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, "CSV value", ROOT.kRed, "Calo jets")
        PFCSV = modules.classes.PlotBase("pfJets_csv","{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, "CSV value", ROOT.kGreen+2, "PF jets")
        PFCSVLeading = modules.classes.PlotBase("pfJets_csv","{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning1, "leading CSV value", ROOT.kPink, "PF jets")
        """
        for sample, postfix, nicename in samples:
...
#            modules.compPlot.compareSumJetSamples(OffCSV, samples, "offCleanCSVJets_csv[?]", 10, commonJetSelection, normalized = True, outname = basepath+globalPrefix+"MatchedJetTypeComp_Off_csv_DataMC")
    ...
    if doDeepCSV and not skiponOffPlots and onlymatch:
        ...
        OffDeepCSV = modules.classes.PlotBase("offCleanDeepCSVJets_deepcsv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, "DeepCSV value", ROOT.kBlue, "Offline jets")
        CaloDeepCSV = modules.classes.PlotBase("caloJets_deepcsv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, "DeepCSV value", ROOT.kRed, "Calo jets")
        PFDeepCSV = modules.classes.PlotBase("pfJets_deepcsv","{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, "DeepCSV value", ROOT.kGreen+2, "PF jets")
        for sample, postfix, nicename in samples:
    ...
    if doperJetComp:
        ...
        if sameTaggerComp:
            ...
            csvZeroCut = "offCleanCSVJets_csv[?] > 0 && pfJets_csv[offCleanCSVJets_matchPF[?]] > 0"
            if doCSV:
                ...
                for sample, postfix, nicename in samples:
                    ...
                    #Define plots
                    CSV2DFullLog = modules.classes.PlotBase2D("offCleanDeepCSVJets_csv","pfJets_csv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2 , "Offline CSV", "matched PF CSV")
                    CSV2DFullLogCalo = modules.classes.PlotBase2D("offCleanDeepCSVJets_csv","caloJets_csv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2 , "Offline CSV", "matched Calo CSV")
                    CSV2DQ1 = modules.classes.PlotBase2D( "offCleanDeepCSVJets_csv","pfJets_csv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning3, binning3 , "Offline CSV", "matched PF CSV")
                    CSV2DQ3 = modules.classes.PlotBase2D("offCleanDeepCSVJets_csv", "pfJets_csv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", [20,0,0.5], [20,0,0.5] , "Offline CSV", "matched PF CSV")
                    #Make Plots
                    #Full range
                    modules.compPlot.make2DSummedPlot(CSV2DFullLog, sample, "offCleanDeepCSVJets_csv[?]",  "pfJets_csv[offCleanDeepCSVJets_matchPF[?]]",10, outname = "{2}{3}/{0}_CSV_2D_OFFvPF_{1}".format(globalPrefix, postfix, basepath, subfolder),
                    ...
                    modules.compPlot.make2DSummedPlot(CSV2DFullLogCalo, sample, "offCleanDeepCSVJets_csv[?]",  "caloJets_csv[offCleanDeepCSVJets_matchCalo[?]]",10, outname = "{2}{3}/{0}_CSV_2D_OFFvCalo_{1}".format(globalPrefix, postfix, basepath, subfolder),
                    ...
                    # Partial range
                    modules.compPlot.make2DSummedPlot(CSV2DQ1, sample, "offCleanDeepCSVJets_csv[?]", "pfJets_csv[offCleanDeepCSVJets_matchPF[?]]", 5, outname = "{2}{3}/{0}_CSV_2D_OFFvPF_Q1_{1}".format(globalPrefix, postfix, basepath, subfolder),
                                                      iterSelection = "{0} && {1}".format(commonJetSelection, csvZeroCut), LogZ = True, label = DSlabel, iterStart = 1)
                    modules.compPlot.make2DSummedPlot(CSV2DQ3, sample, "offCleanDeepCSVJets_csv[?]", "pfJets_csv[offCleanDeepCSVJets_matchPF[?]]", 10, outname = "{2}{3}/{0}_CSV_2D_OFFvPF_Q3_{1}".format(globalPrefix, postfix, basepath, subfolder),
                                                      iterSelection = "{0} && {1}".format(commonJetSelection, csvZeroCut), LogZ = True, label = DSlabel, iterStart = 1)
                    if postfix == "MC":
            ...
            if doDeepCSV:
                ...
                for sample, postfix, nicename in samples:
                    ...
                    fullhistPF[0]  .SetName("PF_X")
                    fullHistCalo[0].SetName("Calo_X")
                    fullhistPF[1]  .SetName("PF_Y")
                    fullHistCalo[1].SetName("Calo_Y")
                    fullhistPF[0]  .Write()
                    fullHistCalo[0].Write()
                    fullhistPF[1]  .Write()
                    fullHistCalo[1].Write()
                ...
                if splitDeepCSV:
                     ...
                     for sample, postfix, nicename in samples:
                         ...
                         DSlabel = getLabel("Dataset: {0}".format(nicename), 0.5)
                         #Define plots
                         DeepCSV2DFullLog = modules.classes.PlotBase2D("offCleanDeepCSVJets_deepcsv_b", "pfJets_deepcsv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2 , "Offline DeepCSV (probb)", "matched PF DeepCSV")
                         DeepCSV2DFullLogCalo = modules.classes.PlotBase2D("offCleanDeepCSVJets_deepcsv_b", "caloJets_deepcsv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2 , "Offline DeepCSV (probb)", "matched Calo DeepCSV")
                         DeepCSV2DQ1 = modules.classes.PlotBase2D("offCleanDeepCSVJets_deepcsv_b","pfJets_deepcsv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning3, binning3 , "Offline DeepCSV (probb)", "matched PF DeepCSV")
                     ...
                     for sample, postfix, nicename in samples:
                         ...
                         DSlabel = getLabel("Dataset: {0}".format(nicename), 0.5)
                         #Define plots
                         DeepCSV2DFullLog = modules.classes.PlotBase2D("offCleanDeepCSVJets_deepcsv_bb", "pfJets_deepcsv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2 , "Offline DeepCSV (probbb)", "matched PF DeepCSV")
                         DeepCSV2DFullLogCalo = modules.classes.PlotBase2D("offCleanDeepCSVJets_deepcsv_bb", "caloJets_deepcsv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2 , "Offline DeepCSV (probbb)", "matched Calo DeepCSV")
                         DeepCSV2DQ1 = modules.classes.PlotBase2D("offCleanDeepCSVJets_deepcsv_bb","pfJets_deepcsv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning3, binning3 , "Offline DeepCSV (probbb)", "matched PF DeepCSV")
        ...
        if crossTaggerComp and doCSV and doDeepCSV:
            ...
            for sample, postfix, nicename in samples:
                ...
                DSlabel = getLabel("Dataset: {0}".format(nicename), 0.5)
                #Define Plots
                OffDeepCSVvPFCSV2DLog = modules.classes.PlotBase2D("offCleanDeepCSVJets_deepcsv", "pfJets_csv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2, "Offline DeepCSV", "matched PF CSV")
                OffDeepCSVvCaloCSV2DLog = modules.classes.PlotBase2D("offCleanDeepCSVJets_deepcsv", "caloJets_csv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2, "Offline DeepCSV", "matched Calo CSV")
                OffCSVvPFDeepCSV2DLog = modules.classes.PlotBase2D("offCleanCSVJets_csv", "pfJets_deepcsv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2, "Offline CSV", "matched PF DeepCSV")
                OffCSVvCaloDeepCSV2DLog = modules.classes.PlotBase2D("offCleanCSVJets_deepcsv", "pfJets_deepcsv", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2, "Offline CSV", "matched Calo DeepCSV")

                OfflineCSVvDeepCSV2DLog = modules.classes.PlotBase2D("offCleanJets_csv", "offCleanJets_deepCSV", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2, "Offline CSV", "Offline DeepCSV")
                PFCSVvDeepCSV2DLog = modules.classes.PlotBase2D("pfJets_csv", "offCleanJets_deepCSV", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2, "PF CSV", "PF DeepCSV")
                CaloCSVvDeepCSV2DLog = modules.classes.PlotBase2D("caloJets_csv", "caloJets_deepCSV", "{0} && {1}".format(plotVarSelection, offlineeventSelection), "1", binning2, binning2, "Calo CSV", "Calo DeepCSV")
